      ...
      <main className="container mx-auto mt-8 px-4">
        <section className="mb-12 relative overflow-hidden rounded-lg bg-gray-800 text-white py-20">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <a href="#" className="bg-blue-600 text-white hover:bg-blue-700 text-lg font-semibold py-3 px-8 rounded-full transition duration-300">Start Your Journey</a>
              <a href="#" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-gray-800 text-lg font-semibold py-3 px-8 rounded-full transition duration-300">Learn More</a>
            </div>
          </div>
        </section>
          ...
          <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} p-6 rounded-lg shadow-lg max-w-2xl mx-auto`}>
            <div className={`h-80 overflow-y-auto mb-4 p-4 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'} rounded-lg`}>
              {chatHistory.map((chat, index) => (
                <div key={index} className={`mb-4 ${chat.type === "user" ? "text-right" : "text-left"}`}>
                  <span className={`inline-block p-3 rounded-lg ${chat.type === "user" ? "bg-blue-600 text-white" : isDarkMode ? "bg-gray-600 text-white" : "bg-gray-300 text-gray-900"}`}>
                    {chat.message}
                  </span>
                </div>
              ))}
            ...
            <form onSubmit={handleChatSubmit} className="flex">
              <input
                ...
                placeholder="Ask Gemini about fitness..."
              ...
              />
              <button type="submit" className="bg-blue-600 text-white p-3 rounded-r-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 transition duration-300">
                <FiSend size={24} />
              </button>
            </form>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300`}>
              <img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Workout" className="w-full h-56 object-cover" />
              <div className="p-6">
                <h3 className="text-2xl font-semibold mb-3">Effective Workouts</h3>
                <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-4`}>Discover our curated workout plans for all fitness levels, designed to help you achieve your goals efficiently.</p>
                <a href="#" className="text-blue-400 font-semibold hover:text-blue-300 transition duration-200">Learn More →</a>
              </div>
            </div>
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300`}>
              <img src="https://images.unsplash.com/photo-1490645935967-10de6ba17061?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Nutrition" className="w-full h-56 object-cover" />
              <div className="p-6">
                <h3 className="text-2xl font-semibold mb-3">Balanced Nutrition</h3>
                <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-4`}>Learn about proper nutrition to fuel your fitness journey and optimize your health and performance.</p>
                <a href="#" className="text-blue-400 font-semibold hover:text-blue-200 transition duration-300">Learn More →</a>
              </div>
            </div>
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300`}>
              <img src="https://images.unsplash.com/photo-1519003300449-424ad0405076?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Sleep" className="w-full h-56 object-cover" />
              <div className="p-6">
                <h3 className="text-2xl font-semibold mb-3">Quality Sleep</h3>
                <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-4`}>Understand the importance of sleep in your fitness routine and learn techniques for better rest and recovery.</p>
                <a href="#" className="text-blue-400 font-semibold hover:text-blue-300 transition duration-200">Learn More →</a>
              </div>
            </div>
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300`}>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="https://www.instagram.com/banh_ng05/?hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition duration-300">
                <FaInstagram size={28} />
              </a>
              <a href="https://www.facebook.com/nguyen.banh.9" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition duration-300">
                <FaFacebook size={28} />
              </a>
              <a href="https://github.com/BanhNg2005" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition duration-300">
                <FaGithub size={28} />
              </a>
            </div>
          </div>
